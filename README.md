...
## (Windows下)AutoHotKey->CapsLock.ahk
...
CapsLock + u: 行首
CapsLock + o: 行尾
CapsLock + r: PowerShell
CapsLock + e: www.bing.com
CapsLock + t: VsCode.exe
CapsLock + f: 翻译
CapsLock + q: 关闭标签页
CapsLock + s: 切换标签页
CapsLock + a/x/c/v/z: 全选/剪切/复制/粘贴/撤销
CapsLock + w: 向后一个单词
CapsLock + b: 向前一个单词
CapsLock + ↑↓←→: 鼠标指针移动
CapsLock + Enter: 鼠标单击
...
! Caps_Lock + ;     -> CapsLock
keycode  47 = semicolon colon Caps_Lock
